  ...
  return (
    <div className="tool-page">
      ...
      <div className="tool-card">
        ...
        <p>Identify the skills you need to develop to achieve your career goals.</p>
        ...
        <div className="tool-form">
          ...
          <button className="generate-btn" onClick={handleGenerate} disabled={loading}>
            {loading ? "Generating Report..." : "Analyze Skill Gaps"}
          </button>
          ...
          {output && (
            <>
              ...
              <button className="pdf-btn" onClick={downloadPDF} style={{ marginTop: "20px" }}>
                📄 Download PDF
              </button>
            </>
          )}
          ...
          <div className="tool-note">
            ✦ AI identifies missing skills and recommends what to learn next.
          </div>
        </div>
      </div>
    </div>
