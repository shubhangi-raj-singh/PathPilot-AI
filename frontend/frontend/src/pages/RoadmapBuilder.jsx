  ...
  return (
    <div className="tool-page">
      ...
      <div className="tool-card">
        ...
        <p>Create a personalized roadmap to achieve your career goals.</p>
        ...
        <div className="tool-form">
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? "Generating Report..." : "Build Roadmap"}
          </button>
          ...
          <div className="tool-note">
            ✦ AI creates a personalized learning roadmap based on your goals.
          </div>
        </div>
      </div>
    </div>
