...
function ProgressTracker() {
  ...
  const downloadPDF = async () => {
    ...
    pdf.save("Progress_Tracker_Report.pdf");
  };
      ...
      <div className="tool-card">
        ...
        <div className="tool-form">
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? "Generating Report..." : "Track Progress"}
          </button>
          ...
          <div className="tool-note">
            ✦ AI helps monitor milestones and keeps your learning journey on track.
          </div>
        </div>
      </div>
    </div>
