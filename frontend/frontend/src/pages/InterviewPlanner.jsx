...
function InterviewPlanner() {
  ...
  const downloadPDF = async () => {
    ...
    pdf.save("Interview_Prep_Plan.pdf");
  };
  ...
  return (
    <div className="tool-page">
      ...
      <div className="tool-card">
        ...
        <p>Plan and prepare for your upcoming interviews.</p>
        ...
        <div className="tool-form">
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? "Generating Report..." : "Plan Interview"}
          </button>
          ...
          <div className="tool-note">
            ✦ AI generates interview preparation strategies and practice plans.
          </div>
        </div>
      </div>
    </div>
